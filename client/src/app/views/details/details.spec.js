...
describe( 'Detail', function() {
  ...
  var scope;
  var DetailsCtrl;
  var detailsData = {"drug":{"brand_name":["Infants TYLENOL"],"purpose":["Purpose Pain reliever/fever reducer"],"generic_name":["ACETAMINOPHEN"],"count":["2"]}};
  ...
  beforeEach( inject( function( $controller, _$location_, $rootScope,_$httpBackend_ ) {
      ...
      DetailsCtrl = $controller( 'DetailsController', { $scope: scope, detailsData: detailsData, eventsData:{"response":{}}, recallsData:{"response":{}},referenceData:{"response":{}}, eventOutcomesChartData:{"result":{}},  eventReactionChartData:{"result":{}} });
   }));
